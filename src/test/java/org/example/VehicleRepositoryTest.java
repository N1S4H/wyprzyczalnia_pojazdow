...
public class VehicleRepositoryTest{
    ...
    @Test
    void getVehiclesShouldReturnDeepCopy() throws FileNotFoundException {
    ...
    @Test
    void addingToReturnedListShouldNotChangeRepository() throws FileNotFoundException {
        IVehicleRepository repo = new VehicleRepositoryImpl();
    ...
    @Test
    void changingReturnedVehicleShouldNotChangeRepository() throws FileNotFoundException {
        IVehicleRepository repo = new VehicleRepositoryImpl();
        List<Vehicle> vehicles = repo.getVehicles();
